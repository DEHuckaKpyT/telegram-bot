...
class RegistrationHandler(
    ...
    command("/register", next = "get_contact") {
        sendMessage(template.register, replyMarkup = contactKeyboard(template.registerContactButton))
    }
    ...
    step("get_firstname") {
        ...
        sendMessage(template.registerComplete with mapOf("firstName" to text, "phoneNumber" to phone))
    }
})