...
@KotlinScript(
    ...
    compilationConfiguration = ScriptWithMavenDependenciesConfiguration::class
)
// the class is used as the script base class, therefore it should be open or abstract
abstract class ScriptWithMavenDependencies

object ScriptWithMavenDependenciesConfiguration : ScriptCompilationConfiguration({
...
//        )
    ...
    refineConfiguration {
        ...
        onAnnotations(DependsOn::class, Repository::class, handler = ::configureMavenDependenciesOnAnnotations)
    }
})
...
fun configureMavenDependenciesOnAnnotations(context: ScriptConfigurationRefinementContext): ResultWithDiagnostics<ScriptCompilationConfiguration> {
