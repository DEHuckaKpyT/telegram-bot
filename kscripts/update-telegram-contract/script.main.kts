        ...
        .addType(
            TypeSpec.classBuilder("TelegramBotImpl")
                ...
                .primaryConstructor(FunSpec.constructorBuilder()
                    ...
                    .addParameter(ParameterSpec.builder("username", String::class.asTypeName().copy(nullable = true))
                        .defaultValue("null")
                        .build())
                ...
                .addProperty(PropertySpec.builder("username", String::class, OVERRIDE)
                    .initializer("username ?: runBlocking(Dispatchers.Default) { getMe() }.username!!")
                    .build())
                ...
                .addProperty(PropertySpec.builder("client", ClassName("io.github.dehuckakpyt.telegrambot.api.client", "TelegramApiClient"), OVERRIDE)
                    .initializer("TelegramApiClient(token, clientConfiguration)")
                    .build())
