...
public interface TelegramBotApi {
     ...
     * keyboard or to force a reply from the user.
     */
    public suspend fun sendLivePhoto(
        chatId: String,
        livePhoto: Input,
        photo: Input,
        businessConnectionId: String? = null,
     ...
     *
     * @param chatId Unique identifier for the target chat or username of the target bot, supergroup
     * or channel in the format `@username`. If the chat is a channel, all Telegram Star proceeds from
     * this media will be credited to the chat's balance. Otherwise, they will be credited to the bot's
     * balance.
     ...
     *
     * @param chatId Unique identifier for the target chat or username of the target bot, supergroup
     * or channel in the format `@username`. Polls can't be sent to channel direct messages chats.
     ...
     * @param businessConnectionId Unique identifier of the business connection on behalf of which
     * the message will be sent
     * @param chatId Unique identifier for the target chat or username of the target bot in the
     * format `@username`
     ...
     * @param draftId Unique identifier of the message draft; must be non-zero. Changes to drafts
     ...
     * administrators.
     */
    public suspend fun answerChatJoinRequestQuery(chatJoinRequestQueryId: String, result: String):
            Boolean

    /**
     * Use this method to process a received chat join request query by showing a Mini App to the
     * user before deciding the outcome. Returns *True* on success.
     *
     * @param chatJoinRequestQueryId Unique identifier of the join request query
     * @param webAppUrl The URL of the Mini App to be opened
     */
    public suspend fun sendChatJoinRequestWebApp(chatJoinRequestQueryId: String, webAppUrl: String):
            Boolean
     ...
     * channel in the format `@username`. Channel direct messages chats aren't supported; leave the
     * corresponding channel instead.
     */
     ...
     */
    public suspend fun getChatAdministrators(chatId: String, returnBots: Boolean? = null):
            List<ChatMember>
     ...
     */
    public suspend fun getUserPersonalChatMessages(userId: Long, limit: Int): List<Message>
     ...
     */
    public suspend fun answerGuestQuery(guestQueryId: String, result: InlineQueryResult):
            SentGuestMessage
     ...
     */
    public suspend fun getManagedBotToken(userId: Long): String
     ...
     */
    public suspend fun replaceManagedBotToken(userId: Long): String
     ...
     */
    public suspend fun getManagedBotAccessSettings(userId: Long): BotAccessSettings
     ...
     */
    public suspend fun setManagedBotAccessSettings(
        userId: Long,
     ...
     */
    public suspend fun setMyProfilePhoto(photo: InputProfilePhoto): Boolean

    /**
     * Removes the profile photo of the bot. Requires no parameters. Returns *True* on success.
     */
    public suspend fun removeMyProfilePhoto(): Boolean

    /**
     * Use this method to change the bot's menu button in a private chat, or the default menu
     * button. Returns *True* on success.
     *
     * @param chatId Unique identifier for the target private chat. If not specified, the bot's
     ...
     * “underline”, “strikethrough”, “spoiler”, “custom_emoji”, and “date_time” are ignored.
     */
    public suspend fun giftPremiumSubscription(
        userId: Long,
        monthCount: Int,
        starCount: Int,
        text: String? = null,
     ...
     */
    public suspend fun verifyUser(userId: Long, customDescription: String? = null): Boolean
     ...
     *
     * @param chatId Unique identifier for the target chat or username of the target bot, supergroup
     * or channel in the format `@username`. Channel direct messages chats can't be verified.
     * @param customDescription Custom description for the verification; 0-70 characters. Must be
     * empty if the organization isn't allowed to provide a custom verification description.
     */
    public suspend fun verifyChat(chatId: String, customDescription: String? = null): Boolean
     ...
     * @param userId Unique identifier of the target user
     */
    public suspend fun removeUserVerification(userId: Long): Boolean
     ...
     * Returns *True* on success.
     *
     * @param chatId Unique identifier for the target chat or username of the target bot or channel
     * in the format `@username`
     */
    public suspend fun removeChatVerification(chatId: String): Boolean
     ...
     * @param businessConnectionId Unique identifier of the business connection on behalf of which
     * to read the message
     * @param chatId Unique identifier of the chat in which the message was received. The chat must
     * have been active in the last 24 hours.
     * @param messageId Unique identifier of the message to mark as read
     */
    public suspend fun readBusinessMessage(
        businessConnectionId: String,
        chatId: Long,
        messageId: Long,
    ): Boolean
     ...
     */
    public suspend fun deleteBusinessMessages(businessConnectionId: String,
     ...
     */
    public suspend fun setBusinessAccountName(
        businessConnectionId: String,
        firstName: String,
        lastName: String? = null,
    ): Boolean
     ...
     */
    public suspend fun setBusinessAccountUsername(businessConnectionId: String, username: String? =
            null): Boolean
     ...
     */
    public suspend fun setBusinessAccountBio(businessConnectionId: String, bio: String? = null):
            Boolean
     ...
     * photo.
     */
    public suspend fun setBusinessAccountProfilePhoto(
        businessConnectionId: String,
     ...
     */
    public suspend fun removeBusinessAccountProfilePhoto(businessConnectionId: String,
     ...
     */
    public suspend fun setBusinessAccountGiftSettings(
        businessConnectionId: String,
     ...
     * @param businessConnectionId Unique identifier of the business connection
     */
    public suspend fun getBusinessAccountStarBalance(businessConnectionId: String): StarAmount
     ...
     */
    public suspend fun transferBusinessAccountStars(businessConnectionId: String, starCount: Int):
            Boolean
     ...
     * Stars
     */
    public suspend fun convertGiftToStars(businessConnectionId: String, ownedGiftId: String):
            Boolean
     ...
     * passed.
     */
    public suspend fun upgradeGift(
        businessConnectionId: String,
        ownedGiftId: String,
     ...
     * required.
     */
    public suspend fun transferGift(
        businessConnectionId: String,
        ownedGiftId: String,
        newOwnerChatId: Long,
        starCount: Int? = null,
     ...
     */
    public suspend fun deleteStory(businessConnectionId: String, storyId: Long): Boolean
     ...
     */
    public suspend fun savePreparedKeyboardButton(userId: Long, button: KeyboardButton):
     ...
     */
    public suspend fun approveSuggestedPost(
        chatId: Long,
        messageId: Long,
        sendDate: Long? = null,
    ): Boolean
     ...
     */
    public suspend fun declineSuggestedPost(
        chatId: Long,
        messageId: Long,
        comment: String? = null,
    ): Boolean
     ...
     * added by a chat
     */
    public suspend fun deleteMessageReaction(
        chatId: String,
        messageId: Long,
        userId: Long? = null,
     ...
     */
    public suspend fun deleteAllMessageReactions(
        chatId: String,
        userId: Long? = null,
        actorChatId: Long? = null,
    ): Boolean
     ...
     * generated. Note that the streamed draft is ephemeral and acts as a temporary 30-second preview -
     * once the output is finalized, you **must** call
     * [sendRichMessage](https://core.telegram.org/bots/api/#sendrichmessage) with the complete message
     * to persist it in the user's chat. Returns *True* on success.
     *
     * @param chatId Unique identifier for the target private chat
     * @param draftId Unique identifier of the message draft; must be non-zero. Changes to drafts
     * with the same identifier are animated.
     ...
     * @param messageThreadId Unique identifier for the target message thread
     */
    public suspend fun sendRichMessageDraft(
        chatId: Long,
        draftId: Long,
        richMessage: InputRichMessage,
        messageThreadId: Long? = null,
     ...
     */
    public suspend fun getMyStarBalance(): StarAmount
     ...
     *
     * @param chatId Unique identifier for the target chat or username of the target bot in the
     * format `@username`. Games can't be sent to channel direct messages chats and channel chats.
