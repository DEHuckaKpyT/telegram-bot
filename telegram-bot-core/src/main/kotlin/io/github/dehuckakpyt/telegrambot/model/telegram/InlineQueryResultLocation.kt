 ...
 * meters; 0-1500
 * @param livePeriod *Optional*. Period in seconds during which the location can be updated, must be
 * between 60 and 86400, or 0x7FFFFFFF for live locations that can be edited indefinitely
...
public data class InlineQueryResultLocation(
    ...
    /**
     * *Optional*. Period in seconds during which the location can be updated, must be between 60
