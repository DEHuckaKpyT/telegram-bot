 ...
 * compatibility, the field contains a fake sender user in non-channel chats, if the message was sent
 * on behalf of a chat.
 * @param senderChat *Optional*. Sender of the message, sent on behalf of a chat. For example, the
 * channel itself for channel posts, the supergroup itself for messages from anonymous group
 * administrators, the linked channel for messages automatically forwarded to the discussion group. For
 * backward compatibility, the field *from* contains a fake sender user in non-channel chats, if the
...
public data class Message(
     ...
     * for channel posts, the supergroup itself for messages from anonymous group administrators, the
