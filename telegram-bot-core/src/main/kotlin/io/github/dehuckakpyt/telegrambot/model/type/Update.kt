...
data class Update(
    ...
    @param:JsonProperty("business_connection") val businessConnection: BusinessConnection? = null,
    @param:JsonProperty("business_message") val businessMessage: Message? = null,
    @param:JsonProperty("edited_business_message") val editedBusinessMessage: Message? = null,
    @param:JsonProperty("deleted_business_messages") val deletedBusinessMessages: BusinessMessagesDeleted? = null,
