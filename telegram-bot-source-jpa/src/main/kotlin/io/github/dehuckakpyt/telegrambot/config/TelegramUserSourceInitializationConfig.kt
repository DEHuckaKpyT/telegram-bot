...
import io.github.dehuckakpyt.telegrambot.config.constant.SourceJpaPropertiesConstant.TELEGRAM_BOT_SOURCE_JPA_USER_SOURCE_ENABLED
...
@ConditionalOnProperty(name = [TELEGRAM_BOT_SOURCE_JPA_ENABLED, TELEGRAM_BOT_SOURCE_JPA_USER_SOURCE_ENABLED], havingValue = "true", matchIfMissing = true)
