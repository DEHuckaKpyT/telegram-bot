...
internal object SourceJpaPropertiesConstant {
    ...
    internal const val TELEGRAM_BOT_SOURCE_JPA_USER_SOURCE = "telegram-bot.source-jpa.user-source.enabled"
    internal const val TELEGRAM_BOT_SOURCE_JPA_CHAT_SOURCE = "telegram-bot.source-jpa.chat-source.enabled"
    internal const val TELEGRAM_BOT_SOURCE_JPA_CHAT_STATUS_EVENT_SOURCE = "telegram-bot.source-jpa.chat-status-event-source.enabled"
