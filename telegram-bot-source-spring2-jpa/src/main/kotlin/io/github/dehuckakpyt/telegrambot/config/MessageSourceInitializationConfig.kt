...
import io.github.dehuckakpyt.telegrambot.config.constant.PropertiesConstant.TELEGRAM_BOT_SOURCE_JPA_MESSAGE_SOURCE
...
class MessageSourceInitializationConfig {
    ...
    fun telegramMessageSourceExpression(repository: JpaTelegramMessageRepository): ConfigExpression<MessageSource> = ConfigExpression { JpaTelegramMessageSource(repository) }
}